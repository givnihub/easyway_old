...
Route::post('/resetPassword',[HomeApi::class,'resetPassword']);
Route::get('/loginInfo/{uid}',[HomeApi::class,'loginInfo']);
...
Route::get('/verifyPayment/{paymentId}',[HomeApi::class,'verifyPayment']);
Route::post('/paymentVerification',[HomeApi::class,'paymentVerification']);
Route::get('/loginInfo/{number}',[HomeApi::class,'loginInfo']);
Route::post('/downloadYoutubeVideos',[HomeApi::class,'downloadYoutubeApi']);
Route::get('/getCoupons/{courseId}/{couponCode}',[HomeApi::class,'getCoupons']);

...
<body class="hold-transition skin-blue fixed sidebar-mini">
                        ...
                        <div id="frame">
                            ...
                            <div id="sidepanel">
                                ...
                                <div id="search">
                                    ...
                                    <div id="bottom-bar">
                                        <button id="addcontact" data-toggle="modal" data-target="#myModal"><i
                            ...
                            <div class="chatcontent">
                                ...
                                <div class="message-input ">
                                    <div class="wrap relative">
                                        ...
                                        <button class="submit input_submit" disabled="disabled"><i
                ...
                if (data.notifications.length > 0) {
                    $.each(data.notifications, function(index, value) {
                        if (active_user.data('chatConnectionId') != value.chat_connection_id) {
                            ...
                            $('#contacts').find("ul li[data-chat-connection-id='" + value
                                    .chat_connection_id + "']").find('span.notification_count')
                                .text(value.no_of_notification).css("display", "block");
                        }
                    });
                }
    ...
    function js_yyyy_mm_dd_hh_mm_ss(now) {
        ...
        var month_String = new Array("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
            "Dec");
        now = new Date();

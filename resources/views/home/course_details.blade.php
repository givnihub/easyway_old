                ...
                <div class="col-lg-3 col-sm-12 col-xs-12">
                    <div class="whatyou coursebox-body relative">
                        ...
                        <div class="coursebtnfull" style="position:relative;">
                            @if(!empty($id))
                            <a href="{{url('course_payment/payment')}}/{{$res->id}}" class="btn btn-add-full">Enroll Now
                            </a>
                            @else
                            <a href="{{url('userlogin')}}" class="btn btn-add-full">Enroll Now
                            </a>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="coursebox">
                                ...
                                <div class="coursebtn">
                                    ...
                                    @if(!empty($id))
                                    <a href="{{url('course_payment/payment')}}/{{$row->id}}" class="btn btn-add course_detail_id"><i class="fa fa-cart-plus"></i> Enroll Now</a>
                                    @else
                                    <a href="{{url('userlogin')}}" class="btn btn-add course_detail_id"><i class="fa fa-cart-plus"></i> Enroll Now</a>

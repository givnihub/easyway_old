                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                               ...
                                               <!-- <span class="input-group-btn">
                                                    <a href="#" class="btn cfees" 
                                                        data-toggle="tooltip" data-title="Select Image" type="button">
                                                ...
                                                <input type="file" name="image" accept="image/png, image/gif, image/jpeg" style="opacity: 1 !important;" />
                                            </div>
                                            <div id="image_preview" class="thumbnail" <?php if(empty($id)){
                                                ...
                                                >
                                                @if(strpos($row[0]->image,"easywayglobal.in")>0)
                                                <img src="{{$row[0]->image}}" class="img-responsive feature_image_url">
                                @else
                                <img src="{{asset('')}}{{$row[0]->image}}" class="img-responsive feature_image_url">
                                @endif

                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="{{url('')}}/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                ...
                                                                <li class="active"><a href="{{url('')}}/admin/feesforward"><i class="fa fa-angle-double-right"></i> Fees Carry Forward</a></li>
...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">  
            <form id='feesforward' action="{{url('')}}/admin/feesforward/index"  method="post" accept-charset="utf-8">
                <div class="col-md-12">

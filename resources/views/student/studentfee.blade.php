    ...
    <li class="dropdown">
        ...
        <ul class="sidebar-menu verttop">
                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class="active"><a href="{{url('')}}/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form  action="{{url('')}}/studentfee/search" method="post" class="class_search_form">

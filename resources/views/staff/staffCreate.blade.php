                                ...
                                <div class="box-body">
                                    ...
                                    <div class="tshadow mb25 bozero">
                                        <!-- <div class="box-tools pull-right pt3">
                                            <a class="btn btn-sm btn-primary" href="{{url('')}}/admin/staff/import" autocomplete="off"><i class="fa fa-plus"></i> Import Staff</a>
                                        ...
                                        <div class="around10">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group"><label for="custom_fields[staff][2]" class="control-label">Code</label><small class='req'>
                                                            *</small><input type="text" step="any" id="custom_fields[staff][2]" name="code" class="form-control" value="<?=$res[0]->code?>" > <span class="text-danger">@error('discount'){{$message}}@enderror</span></div>
                                                </div>
                                            </div>

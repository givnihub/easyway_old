                                                    ...
                                                    <fieldset id="question_{{$i}}" @if($i==0) style="display: block;" @endif>
                                                        ...
                                                        <div class="quizscroll">
                                                            ...
                                                            <div class="radiocontainer">
                                                                <label>
                                                                    <input type="radio" name="radio{{$i}}" value="opt_a" autocomplete="off"> {!!str_replace('<p>','',$question->opt_a)!!} </label>

                                                                <label>
                                                                    <input type="radio" name="radio{{$i}}" value="opt_b" autocomplete="off">{!!str_replace('<p>','',$question->opt_b)!!} </label>

                                                                <label>
                                                                    <input type="radio" name="radio{{$i}}" value="opt_c" autocomplete="off">{!!str_replace('<p>','',$question->opt_c)!!} </label>

                                                                <label>
                                                                    <input type="radio" name="radio{{$i}}" value="opt_d" autocomplete="off">{!!str_replace('<p>','',$question->opt_d)!!}</label>
                                                                @if($question->opt_e!='')
                                                                <label>
                                                                    <input type="radio" name="radio{{$i}}" value="opt_e" autocomplete="off">{!!str_replace('<p>','',$question->opt_e)!!} </label>
                                                                @endif
                                                            </div> <!-- ./radiocontainer -->
                                                        </div>
                                                        <!--./quizscroll-->

                        ...
                        <div class="box box-primary">
                            <div class="box-header ptbnull">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="javascript:void()" onclick="history.back()" class="btn btn-info"> Back</a>
                                </div>
                            </div>
                            <div class="box-body">
                                <div class="aa">
                                            ...
                                            <dl class="row mb10">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="row">
                                                        ...
                                                        <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6">Attempted</dt>
                                                        <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6">{{$total_attempt->attempt}}</dd>
                                ...
                                <div class="row no-print ">
                                    <div class="col-xs-12 ">
                                        <a href="{{url('user/startexam')}}/{{$res->id}}"  class="btn btn-info pull-right" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Please wait"><i class="fa fa-bullhorn"></i> Start Exam</a>
                                    </div>
                                </div>
                                @else
                                <div class="row no-print">
                                    <div class="col-xs-12">
                                        <a href="#"  class="btn btn-danger pull-right" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Please wait"><i class="fa fa-bullhorn"></i> Exceed The Limit</a>
                                    </div>
                                </div>
                                 @endif
                                 <div class="hrexamfirstrow"></div>
                                <div class="row">
                                    ...
                                    <?php 
                                    $question = DB::table("questions")->where("id", $runs->onlineexam_question_id)->first();
                                    ...
                                    <div class="col-xs-12 col-md-12 section-box">
                                        <div>
                                            ...
                                            <div class=" @if($correct=='opt_a' && $given_ans=='opt_a')  text text-success   @elseif($given_ans=='opt_a')  text text-danger  @elseif($correct=='opt_a')  text text-success @endif">
                                                <i class="@if($correct=='opt_a' && $given_ans=='opt_a' ) fa fa-check-circle-o @elseif ($correct=='opt_a') fa fa-dot-circle-o @elseif($given_ans=='opt_a') fa fa-times-circle-o @else fa fa-dot-circle-o @endif"></i> {!!str_replace('<p>','',$question->opt_a)!!} </div>

                                            <div class=" @if($correct=='opt_b' && $given_ans=='opt_b')  text text-success   @elseif($given_ans=='opt_b')  text text-danger  @elseif($correct=='opt_b')  text text-success @endif">
                                            <i class="@if($correct=='opt_b' && $given_ans=='opt_b' ) fa fa-check-circle-o @elseif ($correct=='opt_b') fa fa-dot-circle-o @elseif($given_ans=='opt_b') fa fa-times-circle-o @else fa fa-dot-circle-o  @endif"></i> {!!str_replace('<p>','', $question->opt_b)!!} </div>
                                            
                                            <div class=" @if($correct=='opt_c' && $given_ans=='opt_c')  text text-success   @elseif($given_ans=='opt_c')  text text-danger  @elseif($correct=='opt_c')  text text-success @endif">
                                            <i class="@if($correct=='opt_c' && $given_ans=='opt_c' ) fa fa-check-circle-o @elseif ($correct=='opt_c') fa fa-dot-circle-o @elseif($given_ans=='opt_c') fa fa-times-circle-o @else fa fa-dot-circle-o @endif"></i> {!!str_replace('<p>','', $question->opt_c)!!} </div>
                                          
                                                <div class=" @if($correct=='opt_d' && $given_ans=='opt_d')  text text-success   @elseif($given_ans=='opt_d')  text text-danger  @elseif($correct=='opt_d')  text text-success @endif">
                                                <i class="@if($correct=='opt_d' && $given_ans=='opt_d' ) fa fa-check-circle-o @elseif ($correct=='opt_d') fa fa-dot-circle-o @elseif($given_ans=='opt_d') fa fa-times-circle-o @else fa fa-dot-circle-o @endif"></i> {!!str_replace('<p>','',$question->opt_d)!!} </div>
                                            @if($question->opt_e!='')
                                          
                                            <div class=" @if($correct=='opt_e' && $given_ans=='opt_e')  text text-success   @elseif($given_ans=='opt_e')  text text-danger  @elseif($correct=='opt_e')  text text-success @endif">
                                            <i class="@if($correct=='opt_e' && $given_ans=='opt_e' ) fa fa-check-circle-o @elseif ($correct=='opt_e') fa fa-dot-circle-o @elseif($given_ans=='opt_e') fa fa-times-circle-o @else fa fa-dot-circle-o @endif"></i> {!!str_replace('<p>','', $question->opt_e)!!} </div>
                                            @endif


                                            <p>

                                                <b>Explanation :{!!str_replace('<p>','',$question->explanation)!!}</b>
                                            </p>
                                        </div>
                                    </div>
                                    @endforeach

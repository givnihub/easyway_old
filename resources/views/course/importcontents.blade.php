                                ...
                                <form method="post" action="{{url('admin/import')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row text-left">
                                        ...
                                        <div class="col-lg-4 col-sm-4">
                                            <input type="text" name="keyword" onkeypress=processChange() placeholder="Enter course name" id="search" class="form-control">
                                        </div>
                                    @csrf
                                 
                                    @if($_GET['folderid']!='')
        <input type="hidden" name="parent_folder_id" value="{{$_GET['folderid']}}" id="parent_folder_id" required>
                                    @endif
                                    @if($_GET['folderid']=='')
                                    <div class="row text-left">
                                        <div class="col-lg-2 col-sm-6">
...
const processChange = debounce(() => searchCourses());
    </script>

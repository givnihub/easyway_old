            ...
            <div class="ajax_questions">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        @endif
                        @if($can_edit>0)
                        <a href="{{url('exam/addquestion')}}?qid={{$row->id}}" data-placement="left" class="btn btn-default btn-xs question-btn-edit" data-toggle="tooltip" id="load"  title="Edit"><i class="fa fa-pencil"></i>

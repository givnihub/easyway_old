...
<div id="list">
    ...
    <ul>
            ...
            <?php $courseRow=DB::table("courses")->where("id",$run->course_id)->first(['title','course_thumbnail','description']);
...
<div class="row text-left folder_design">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row">
                    <a href="javascript:void()" class="view_folder" data-id="0" data-courseid={{$run->course_id}}>
                    <div class="col-lg-5 col-md-5 col-sm-5">  
                        <img src="{{asset('')}}{{$courseRow->course_thumbnail}}" style="height:80px;">
                    </div>

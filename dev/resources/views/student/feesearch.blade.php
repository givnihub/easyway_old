                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="{{url('')}}/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                ...
                                                                <li class="active"><a href="{{url('')}}/studentfee/feesearch"><i class="fa fa-angle-double-right"></i> Search Due Fees </a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="{{url('')}}/studentfee/feesearch"  method="post" accept-charset="utf-8">
                        <div class="box-body">

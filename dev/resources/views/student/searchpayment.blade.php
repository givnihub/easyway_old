                    ...
                    <li class="treeview ">
                        ...
                        <ul class="treeview-menu">
                                                            <li class=""><a href="{{url('')}}/studentfee"><i class="fa fa-angle-double-right"></i> Collect Fees</a></li>
                                                                <li class="active"><a href="{{url('')}}/studentfee/searchpayment"><i class="fa fa-angle-double-right"></i> Search Fees Payment</a></li>
                                                                ...
                                                                <li class=""><a href="{{url('')}}/admin/feereminder/setting"><i class="fa fa-angle-double-right"></i> Fees Reminder</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="{{url('')}}/studentfee/searchpayment" method="post" class="form-inline">

...
<footer class="main-footer">
    &copy;  <?=date('Y')?>    Easy Way Global</footer>
...
<div class="row">
    <div class="modal fade" id="sessionModal" tabindex="-1" role="dialog" aria-labelledby="sessionModalLabel">
        <form action="/admin/admin/activeSession" id="form_modal_session" class="">
...
<div id="activelicmodal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/admin/admin/updatePurchaseCode" method="POST" id="purchase_code">
